...
public class EhPartitionConsumerForResponses : EhPartitionConsumer
{
        ...
        : base(messageBus, pathGroupPartition)
    {
        ...
        MessageProcessor = new ResponseMessageProcessor<EventData>(_requestResponseSettings, MessageBus, messagePayloadProvider: eventData => eventData.EventBody.ToArray());
